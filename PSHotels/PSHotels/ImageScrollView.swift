...
//        }
        ...
        // center horizontally
        if frameToCenter.size.width < Common.instance.screenSize.width {
            frameToCenter.origin.x = (Common.instance.screenSize.width - frameToCenter.size.width) / 2
        }
        else {
            frameToCenter.origin.x = 0
        }
        ...
        // center vertically
        if frameToCenter.size.height < Common.instance.screenSize.height - 100 {
            frameToCenter.origin.y = (Common.instance.screenSize.height - 100 - frameToCenter.size.height) / 2
        }
        else {
            frameToCenter.origin.y = 0
        }
    ...
    open func display(image: UIImage) {
        ...
        zoomView?.sd_setImage(with: URL(string: url), placeholderImage: UIImage(named: "PlaceholderImage"))
        */
