...
class HotelCollectionViewCell: UICollectionViewCell {
    ...
    func setupUI() {
        ...
        hotelNameLabel.textColor = Common.instance.colorWithHexString("#FFFFFF")
        
        // hotel address
        addressLabel.font = customFont.tagUIFont
        addressLabel.textColor = Common.instance.colorWithHexString("#FFFFFF")
        
        
        // price range
        priceRangeLabel.font = customFont.subHeaderBoldUIFont
        priceRangeLabel.textColor = Common.instance.colorWithHexString("#FFFFFF")
