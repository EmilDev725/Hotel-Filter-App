...
class PSUIViewController : UIViewController {
    ...
    func updateNavigationStuff() {
        ...
        self.navigationController?.navigationBar.titleTextAttributes = [ NSAttributedStringKey.font: customFont.menuUIFont,  NSAttributedStringKey.foregroundColor:  configs.colorTextAlt]
